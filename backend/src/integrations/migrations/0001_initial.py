    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "zoom_meeting_id",
                    models.CharField(db_index=True, help_text="Zoom meeting ID", max_length=20),
                ),
                (
                    "zoom_meeting_uuid",
                    models.CharField(
                ...
                (
                    "topic",
                    models.CharField(blank=True, help_text="Meeting topic from Zoom", max_length=300),
                ),
                (
                    "recording_start",
                ...
                (
                    "duration_seconds",
                    models.PositiveIntegerField(default=0, help_text="Recording duration in seconds"),
                ),
                (
                    "total_size_bytes",
                    models.BigIntegerField(default=0, help_text="Total size of all recording files"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "auto_publish",
                    models.BooleanField(default=False, help_text="Automatically publish when available"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "download_url",
                    models.URLField(blank=True, help_text="Zoom download URL", max_length=2000),
                ),
                (
                    "play_url",
                    models.URLField(
                ...
                (
                    "share_url",
                    models.URLField(blank=True, help_text="Shareable URL", max_length=2000),
                ),
                (
                    "storage_url",
                    models.URLField(
                ...
                (
                    "is_visible",
                    models.BooleanField(default=True, help_text="Whether this file is shown to viewers"),
                ),
                (
                    "recording",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "headers",
                    models.JSONField(default=dict, help_text="Request headers (for debugging)"),
                ),
                (
                    "processing_status",
                    models.CharField(
                ...
                (
                    "processed_at",
                    models.DateTimeField(blank=True, help_text="When processing completed", null=True),
                ),
                (
                    "processing_attempts",
                    models.PositiveIntegerField(default=0, help_text="Number of processing attempts"),
                ),
                ...
                (
                    "error_traceback",
                    models.TextField(blank=True, help_text="Full traceback for debugging"),
                ),
                (
