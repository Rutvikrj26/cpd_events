    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "zoom_meeting_id",
                    models.CharField(
                        db_index=True, help_text="Zoom meeting ID", max_length=20
                    ),
                ),
                (
                    "zoom_meeting_uuid",
                ...
                (
                    "topic",
                    models.CharField(
                        blank=True, help_text="Meeting topic from Zoom", max_length=300
                    ),
                ),
                (
                    "recording_start",
                    models.DateTimeField(help_text="When recording started"),
                ),
                (
                    "recording_end",
                    models.DateTimeField(help_text="When recording ended"),
                ),
                (
                    "duration_seconds",
                ...
                (
                    ...
                    models.BigIntegerField(
                        default=0, help_text="Total size of all recording files"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "thumbnail_url",
                    models.URLField(blank=True, help_text="Custom thumbnail image URL"),
                ),
                (
                    "is_published",
                    models.BooleanField(
                ...
                (
                    "auto_publish",
                    models.BooleanField(
                        default=False, help_text="Automatically publish when available"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "zoom_file_id",
                    models.CharField(help_text="Zoom's file ID", max_length=100),
                ),
                (
                    "file_type",
                    models.CharField(
                ...
                (
                    "download_url",
                    models.URLField(
                        blank=True, help_text="Zoom download URL", max_length=2000
                    ),
                ),
                (
                    "play_url",
                ...
                (
                    "share_url",
                    models.URLField(
                        blank=True, help_text="Shareable URL", max_length=2000
                    ),
                ),
                (
                    "storage_url",
                ...
                (
                    "is_visible",
                    models.BooleanField(
                        default=True, help_text="Whether this file is shown to viewers"
                    ),
                ),
                (
                    "recording",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "event_timestamp",
                    models.DateTimeField(help_text="When event occurred (from Zoom)"),
                ),
                (
                    "zoom_meeting_id",
                    models.CharField(
                ...
                (
                    "headers",
                    models.JSONField(
                        default=dict, help_text="Request headers (for debugging)"
                    ),
                ),
                (
                    "processing_status",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, help_text="Number of attendance records created"
                    ),
                ),
                (
                    "event",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["event"], name="email_logs_event_i_b3d2ce_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="zoomrecording",
            index=models.Index(
                fields=["zoom_recording_id"], name="zoom_record_zoom_re_8fecfd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="zoomrecording",
            index=models.Index(
                fields=["zoom_meeting_id"], name="zoom_record_zoom_me_11f00f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="zoomrecording",
        ...
        migrations.AddIndex(
            model_name="zoomrecording",
            index=models.Index(
                fields=["is_published", "-recording_start"],
                name="zoom_record_is_publ_bde77c_idx",
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["recording", "file_type"], name="zoom_record_recordi_00564b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="zoomrecordingfile",
            index=models.Index(
                fields=["zoom_file_id"], name="zoom_record_zoom_fi_52e8c7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="zoomwebhooklog",
            index=models.Index(
                fields=["webhook_id"], name="zoom_webhoo_webhook_89f681_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="zoomwebhooklog",
            index=models.Index(
                ...
                name="zoom_webhoo_event_t_2ab94b_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="zoomwebhooklog",
            index=models.Index(
                fields=["zoom_meeting_id"], name="zoom_webhoo_zoom_me_6b26d2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="zoomwebhooklog",
            index=models.Index(
                ...
                name="zoom_webhoo_process_ec8a08_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="zoomwebhooklog",
            index=models.Index(
                fields=["event", "-event_timestamp"],
                name="zoom_webhoo_event_i_c0dbc9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="zoomwebhooklog",
            index=models.Index(
                fields=["-created_at"], name="zoom_webhoo_created_d1aee2_idx"
            ),
        ),
    ]
