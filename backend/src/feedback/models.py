...
class EventFeedback(BaseModel):
    ...
    rating = models.PositiveIntegerField(
        validators=[MinValueValidator(1), MaxValueValidator(5)], help_text="Overall event rating (1-5)"
    )
    content_quality_rating = models.PositiveIntegerField(
        validators=[MinValueValidator(1), MaxValueValidator(5)], help_text="Rating of content quality and relevance (1-5)"
    )
    speaker_rating = models.PositiveIntegerField(
        validators=[MinValueValidator(1), MaxValueValidator(5)], help_text="Rating of speaker effectiveness (1-5)"
    )
