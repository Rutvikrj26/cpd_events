    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'qrcode',
                    models.ImageField(blank=True, help_text='QR code image', null=True, upload_to='certificates/qrcodes/'),
                ),
                (
                    'status',
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'width_px',
                    models.PositiveIntegerField(default=1056, help_text='Template width in pixels (default: 11in @ 96dpi)'),
                ),
                (
                    'height_px',
                    models.PositiveIntegerField(default=816, help_text='Template height in pixels (default: 8.5in @ 96dpi)'),
                ),
                (
                    'orientation',
                    models.CharField(
                ...
                (
                    'usage_count',
                    models.PositiveIntegerField(default=0, help_text='Number of certificates issued with this template'),
                ),
                (
                    'last_used_at',
                    models.DateTimeField(blank=True, help_text='When last used to issue a certificate', null=True),
                ),
            ],
            options={
