        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Template description", max_length=500
                    ),
                ),
                (
                    "file_url",
                ...
                (
                    "version",
                    models.PositiveIntegerField(
                        default=1, help_text="Template version number"
                    ),
                ),
                (
                    "is_latest_version",
                    models.BooleanField(
                        default=True, help_text="Is this the latest version"
                    ),
                ),
                (
                    "is_default",
                    models.BooleanField(
                        default=False, help_text="Default template for new events"
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Available for selection (not archived)"
                    ),
                ),
                (
                    "usage_count",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file_url",
                    models.URLField(
                        blank=True, help_text="URL to generated PDF in cloud storage"
                    ),
                ),
                (
                    "file_generated_at",
                    models.DateTimeField(
                        blank=True, help_text="When PDF was generated", null=True
                    ),
                ),
                (
                    "certificate_data",
                    models.JSONField(
                        default=dict, help_text="Snapshot of data at time of issuance"
                    ),
                ),
                ...
                (
                    "first_downloaded_at",
                    models.DateTimeField(
                        blank=True, help_text="First time PDF was downloaded", null=True
                    ),
                ),
