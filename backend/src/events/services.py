...
class ZoomMeetingService:
    ...
    def _get_access_token(self, user) -> Optional[str]:
    ...
    def create_meeting(self, event) -> Dict[str, Any]:
        ...
        try:
            ...
            event.save(update_fields=[
                ...
                'zoom_host_url', 'zoom_password', 'updated_at'
            ])
            
            return {
                'success': True,
                'meeting_id': event.zoom_meeting_id,
                'join_url': event.zoom_join_url
            }
...
class EventService:
    ...
    def duplicate_event(
        ...
        new_start: Optional['timezone.datetime'] = None
    ) -> Dict[str, Any]:
        """
