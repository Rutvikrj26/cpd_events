...
class TestEventReconciliation:
    ...
    def test_unmatched_participants_success(self, api_client, organization, db):
        ...
        AttendanceRecord.objects.create(
            event=event,
            registration=reg1,
            zoom_user_email="matched@example.com",
            is_matched=True,
    ...
    def test_match_participant_manual(self, api_client, organization, db):
    ...
    def test_unmatched_participants_no_zoom(self, api_client, organization, db):
