    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(help_text="URL-friendly identifier", max_length=250, unique=True),
                ),
                (
                    "description",
                    models.TextField(
                ...
                (
                    "timezone",
                    models.CharField(default="UTC", help_text="Event timezone", max_length=50),
                ),
                (
                    "starts_at",
                ...
                (
                    "actual_start_at",
                    models.DateTimeField(blank=True, help_text="When event actually started", null=True),
                ),
                (
                    "actual_end_at",
                    models.DateTimeField(blank=True, help_text="When event actually ended", null=True),
                ),
                (
                    "registration_enabled",
                    models.BooleanField(default=True, help_text="Accept new registrations"),
                ),
                (
                    "max_attendees",
                    models.PositiveIntegerField(
                ...
                (
                    ...
                    models.DateTimeField(blank=True, help_text="Registration cutoff time", null=True),
                ),
                (
                    "waitlist_enabled",
                    models.BooleanField(default=False, help_text="Enable waitlist when full"),
                ),
                (
                    "waitlist_max",
                    models.PositiveIntegerField(blank=True, help_text="Max waitlist size", null=True),
                ),
                (
                    "allow_guest_registration",
                    models.BooleanField(default=True, help_text="Allow registration without account"),
                ),
                (
                    "zoom_meeting_id",
                    models.CharField(
                ...
                (
                    "zoom_meeting_uuid",
                    models.CharField(blank=True, help_text="Zoom meeting UUID", max_length=100),
                ),
                (
                    "zoom_join_url",
                    models.URLField(blank=True, help_text="Zoom join URL for attendees"),
                ),
                (
                    "zoom_start_url",
                    models.URLField(blank=True, help_text="Zoom start URL for host", max_length=2000),
                ),
                (
                    "zoom_password",
                    models.CharField(blank=True, help_text="Zoom meeting password", max_length=50),
                ),
                (
                    "zoom_settings",
                    models.JSONField(
                ...
                (
                    "cpd_enabled",
                    models.BooleanField(default=True, help_text="Event offers CPD credits"),
                ),
                (
                    "cpd_credit_type",
                    models.CharField(
                ...
                (
                    ...
                    models.TextField(blank=True, help_text="Accreditation details", max_length=1000),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(default=True, help_text="Issue certificates for this event"),
                ),
                (
                    "auto_issue_certificates",
                    models.BooleanField(default=False, help_text="Auto-issue when event completes"),
                ),
                (
                    "cover_image_url",
                ...
                (
                    "recording_enabled",
                    models.BooleanField(default=False, help_text="Enable cloud recording"),
                ),
                (
                ...
                (
                    "is_public",
                    models.BooleanField(default=True, help_text="Visible in public listings"),
                ),
                (
                    "registration_count",
                    models.PositiveIntegerField(default=0, help_text="Confirmed registrations"),
                ),
                (
                    "waitlist_count",
                    models.PositiveIntegerField(default=0, help_text="Waitlisted registrations"),
                ),
                (
                    "attendance_count",
                    models.PositiveIntegerField(default=0, help_text="Attendees who joined"),
                ),
                (
                    "certificate_count",
                    models.PositiveIntegerField(default=0, help_text="Certificates issued"),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "required",
                    models.BooleanField(default=False, help_text="Is this field required"),
                ),
                (
                    "placeholder",
                    models.CharField(blank=True, help_text="Placeholder text", max_length=200),
                ),
                (
                    "help_text",
                    models.CharField(
                ...
                (
                    "order",
                    models.PositiveIntegerField(default=0, help_text="Display order (0 = first)"),
                ),
                (
                    "event",
                    models.ForeignKey(
