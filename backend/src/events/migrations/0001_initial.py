    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='Event description (supports markdown)', max_length=10000)),
                ('short_description', models.CharField(blank=True, help_text='Brief description for listings', max_length=500)),
                ('event_type', models.CharField(choices=[('webinar', 'Webinar'), ('workshop', 'Workshop'), ('training', 'Training Session'), ('lecture', 'Lecture'), ('seminar', 'Seminar / Series'), ('other', 'Other')], default='webinar', help_text='Type of event', max_length=20)),
                ('format', models.CharField(choices=[('online', 'Online'), ('in-person', 'In Person'), ('hybrid', 'Hybrid')], default='online', help_text='Event format', max_length=20)),
                ('is_multi_session', models.BooleanField(default=False, help_text='Is this a multi-session event?')),
                ('learning_objectives', models.JSONField(blank=True, default=list, help_text='List of learning objectives (strings)')),
                ('multi_session_completion_criteria', models.CharField(choices=[('all_sessions', 'All Sessions'), ('percentage_of_sessions', 'Percentage of Sessions'), ('min_sessions_count', 'Minimum Number of Sessions'), ('total_minutes', 'Total Attendance Minutes (across all sessions)')], default='total_minutes', help_text='Criteria for marking a multi-session event as completed for certificate eligibility', max_length=50)),
                ('multi_session_completion_value', models.DecimalField(blank=True, decimal_places=2, help_text='Value for multi-session completion criteria (e.g., 80 for percentage, 3 for min sessions)', max_digits=5, null=True)),
                ('status', models.CharField(choices=[('draft', 'Draft'), ('published', 'Published'), ('live', 'Live'), ('completed', 'Completed'), ('closed', 'Closed'), ('cancelled', 'Cancelled')], db_index=True, default='draft', max_length=20)),
                ...
                ('currency', models.CharField(choices=[('USD', 'US Dollar ($)'), ('CAD', 'Canadian Dollar (CA$)'), ('EUR', 'Euro (€)'), ('GBP', 'British Pound (£)'), ('AUD', 'Australian Dollar (A$)'), ('JPY', 'Japanese Yen (¥)'), ('INR', 'Indian Rupee (₹)')], default='USD', help_text='Currency code (ISO 4217)', max_length=3)),
                ('price', models.DecimalField(decimal_places=2, default=0.0, help_text='Ticket price (0.00 for free)', max_digits=10)),
                ...
                ('video_settings', models.JSONField(blank=True, default=dict, help_text='Video conferencing settings — see VideoSettingsSerializer')),
                ('cpd_enabled', models.BooleanField(default=True, help_text='Event offers CPD credits')),
                ('cpd_credit_type', models.CharField(blank=True, help_text='Type of CPD credits (e.g., CME, CPE)', max_length=50)),
                ('cpd_credit_value', models.DecimalField(decimal_places=2, default=0, help_text='Number of CPD credits', max_digits=5)),
                ...
                ('minimum_attendance_percent', models.PositiveIntegerField(default=80, help_text='Minimum % attendance for certificate', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('reminder_offsets_minutes', models.JSONField(blank=True, default=list, help_text='List of minutes-before-start to send reminders (e.g. [10080, 1440, 60, 0]).')),
                ...
                ('require_feedback_for_certificate', models.BooleanField(default=False, help_text='Require attendees to submit feedback before downloading/accessing certificate')),
                ...
                ('featured_image', models.ImageField(blank=True, help_text='Featured image upload', null=True, upload_to='events/featured_images/')),
                ...
                ('badge_template', models.ForeignKey(blank=True, help_text='Template for badges', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='events', to='badges.badgetemplate')),
                ('certificate_template', models.ForeignKey(blank=True, help_text='Template for certificates', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='events', to='certificates.certificatetemplate')),
                ('owner', models.ForeignKey(help_text='Organizer who owns this event', on_delete=django.db.models.deletion.PROTECT, related_name='events', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Event',
                ...
                'db_table': 'events',
                'ordering': ['-starts_at'],
                'permissions': [('can_create_event', 'Can create events'), ('can_manage_event', 'Can manage events')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_type', models.CharField(choices=[('text', 'Single Line Text'), ('textarea', 'Multi-line Text'), ('select', 'Dropdown'), ('multiselect', 'Multi-select'), ('checkbox', 'Checkbox'), ('radio', 'Radio Buttons'), ('date', 'Date'), ('number', 'Number')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_settings', models.JSONField(blank=True, default=dict, help_text='Video conferencing settings (e.g., {enabled: true})')),
                ('cpd_credits', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('is_mandatory', models.BooleanField(default=True)),
                ('is_published', models.BooleanField(default=True)),
                ('minimum_attendance_percent', models.PositiveIntegerField(default=80, help_text='Minimum attendance percentage for this session')),
