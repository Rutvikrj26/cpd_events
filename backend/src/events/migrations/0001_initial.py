    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('webinar', 'Webinar'), ('workshop', 'Workshop'), ('training', 'Training Session'), ('lecture', 'Lecture'), ('other', 'Other')], default='webinar', help_text='Type of event', max_length=20)),
