    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', common.fields.LowercaseEmailField(db_index=True, help_text='Contact email (canonical, lowercase)', max_length=254)),
                ...
                ('source', models.CharField(blank=True, help_text='How contact was added (manual, csv, registration)', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['name'],
                'permissions': [('can_manage_contacts', 'Can manage contacts')],
            },
        ),
        migrations.CreateModel(
            name='Tag',
