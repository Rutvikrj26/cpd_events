...
class BadgeService:
    ...
    def issue_badge(self, template, issued_by=None, registration=None, course_enrollment=None) -> dict[str, Any]:
        ...
        try:
            ...
            if registration:
                ...
                owner = course_enrollment.course.owner
            else:
            ...
            with transaction.atomic():
                # Check limits and increment atomically (badges share certificate limit)
    ...
    def send_badge_email(self, badge) -> bool:
        ...
        try:
            ...
            title = (
                badge.registration.event.title
                if badge.registration
                else (badge.course_enrollment.course.title if badge.course_enrollment else "Training")
            )
