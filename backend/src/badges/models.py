...
class BadgeTemplate(SoftDeleteModel):
    ...
    # Template Image
    start_image = models.ImageField(upload_to="badges/templates/", help_text="Base image for the badge (PNG/JPG)")
...
class IssuedBadge(SoftDeleteModel):
    ...
    # Verification
    verification_code = models.CharField(max_length=30, unique=True, default=generate_verification_code, db_index=True)
