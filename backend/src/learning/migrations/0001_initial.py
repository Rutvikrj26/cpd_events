...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['content', 'registration'], name='quiz_attemp_content_33cfe6_idx'),
        ),
        migrations.AddIndex(
            model_name='quizattempt',
            index=models.Index(fields=['content', 'course_enrollment'], name='quiz_attemp_content_328b55_idx'),
        ),
        migrations.AddIndex(
            model_name='quizattempt',
