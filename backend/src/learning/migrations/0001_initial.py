    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(default='USD', help_text='Price currency', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'event',
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modules', to='events.event'),
                ),
                (
                    'prerequisite_module',
                    models.ForeignKey(
