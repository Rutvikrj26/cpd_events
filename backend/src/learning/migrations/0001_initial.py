    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format', models.CharField(choices=[('online', 'Online (Self-Paced)'), ('hybrid', 'Hybrid (Includes Live Sessions)')], default='online', help_text='Delivery format', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_type', models.CharField(choices=[('lifetime', 'Lifetime Access'), ('limited', 'Limited Access'), ('subscription', 'Subscription Access')], default='lifetime', max_length=20)),
