...
from learning.models import Course, CourseEnrollment, CourseModule, EventModule, ModuleContent, ContentProgress, ModuleProgress
...
class TestCourseProgressArchitecture:
    def test_course_enrollment_progress(self):
        ...
        mod_progress = ModuleProgress.objects.create(
            course_enrollment=enrollment,
            module=event_module
        )
