    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(default='USD', help_text='Currency code for fixed-amount discounts', max_length=3)),
                ...
                ('stripe_coupon_id', models.CharField(blank=True, help_text='Stripe Coupon id created for this promo code', max_length=64, null=True, unique=True)),
                ('stripe_promotion_code_id', models.CharField(blank=True, db_index=True, help_text='Stripe Promotion Code id (promo_...); redeemed at checkout', max_length=64, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='promo_code_usages', to='billing.coursepurchase')),
                ('registration', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='promo_code_usages', to='registrations.registration')),
        ...
        migrations.AddIndex(
            model_name='promocodeusage',
            index=models.Index(fields=['purchase'], name='promo_code__purchas_f67c80_idx'),
        ),
        migrations.AddConstraint(
            model_name='promocodeusage',
            constraint=models.UniqueConstraint(condition=models.Q(('registration__isnull', False)), fields=('registration', 'promo_code'), name='uniq_promo_usage_per_registration_code'),
        ),
        migrations.AddConstraint(
            model_name='promocodeusage',
            constraint=models.UniqueConstraint(condition=models.Q(('purchase__isnull', False)), fields=('purchase', 'promo_code'), name='uniq_promo_usage_per_purchase_code'),
        ),
        migrations.AddConstraint(
            model_name='promocodeusage',
            constraint=models.CheckConstraint(condition=models.Q(('registration__isnull', False), ('purchase__isnull', False), _connector='OR'), name='promo_usage_has_target'),
        ),
    ]
