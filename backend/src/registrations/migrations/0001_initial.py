    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "full_name",
                    models.CharField(help_text="Full name as entered at registration", max_length=255),
                ),
                (
                    "professional_title",
                ...
                (
                    "attended",
                    models.BooleanField(default=False, help_text="Whether attendee joined the event"),
                ),
                (
                    "first_join_at",
                    models.DateTimeField(blank=True, help_text="First time attendee joined", null=True),
                ),
                (
                    "last_leave_at",
                    models.DateTimeField(blank=True, help_text="Last time attendee left", null=True),
                ),
                (
                ...
                (
                    "attendance_eligible",
                    models.BooleanField(default=False, help_text="Met minimum attendance threshold"),
                ),
                (
                    "attendance_override",
                    models.BooleanField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.TextField(blank=True, help_text="Response value (JSON for multi-select)"),
                ),
                (
                    "field",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "zoom_user_name",
                    models.CharField(blank=True, help_text="Display name in Zoom", max_length=255),
                ),
                (
                    "join_method",
                    models.CharField(
                ...
                (
                    "ip_address",
                    models.GenericIPAddressField(blank=True, help_text="IP address (if available)", null=True),
                ),
                (
                    "location",
                    models.CharField(blank=True, help_text="GeoIP location", max_length=100),
                ),
                (
                    "join_time",
                    models.DateTimeField(db_index=True, help_text="When participant joined"),
                ),
                (
                    "leave_time",
                    models.DateTimeField(
                ...
                (
                    "duration_minutes",
                    models.PositiveIntegerField(default=0, help_text="Duration in minutes"),
                ),
                (
                    "is_matched",
                    models.BooleanField(
                ...
                (
                    "matched_at",
                    models.DateTimeField(blank=True, help_text="When match was made", null=True),
                ),
                (
                    "matched_manually",
                    models.BooleanField(default=False, help_text="Match was done manually by organizer"),
                ),
                (
                    "event",
                    models.ForeignKey(
