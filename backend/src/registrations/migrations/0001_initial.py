...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "full_name",
                    models.CharField(
                        help_text="Full name as entered at registration", max_length=255
                    ),
                ),
                (
                    "professional_title",
                    models.CharField(
                        blank=True, help_text="Professional title", max_length=255
                    ),
                ),
                (
                    "organization_name",
                    models.CharField(
                        blank=True, help_text="Organization/company", max_length=255
                    ),
                ),
                (
                    "status",
                ...
                (
                    "attended",
                    models.BooleanField(
                        default=False, help_text="Whether attendee joined the event"
                    ),
                ),
                (
                    "first_join_at",
                    models.DateTimeField(
                        blank=True, help_text="First time attendee joined", null=True
                    ),
                ),
                (
                    "last_leave_at",
                    models.DateTimeField(
                        blank=True, help_text="Last time attendee left", null=True
                    ),
                ),
                (
                ...
                (
                    "attendance_eligible",
                    models.BooleanField(
                        default=False, help_text="Met minimum attendance threshold"
                    ),
                ),
                (
                    "attendance_override",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.TextField(
                        blank=True, help_text="Response value (JSON for multi-select)"
                    ),
                ),
                (
                    "field",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "zoom_user_name",
                    models.CharField(
                        blank=True, help_text="Display name in Zoom", max_length=255
                    ),
                ),
                (
                    "join_method",
                ...
                (
                    ...
                    models.GenericIPAddressField(
                        blank=True, help_text="IP address (if available)", null=True
                    ),
                ),
                (
                    "location",
                    models.CharField(
                        blank=True, help_text="GeoIP location", max_length=100
                    ),
                ),
                (
                    "join_time",
                    models.DateTimeField(
                        db_index=True, help_text="When participant joined"
                    ),
                ),
                (
                    "leave_time",
                ...
                (
                    "matched_at",
                    models.DateTimeField(
                        blank=True, help_text="When match was made", null=True
                    ),
                ),
                (
                    "matched_manually",
                    models.BooleanField(
                        default=False, help_text="Match was done manually by organizer"
                    ),
                ),
                (
                    "event",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["event", "status"], name="registratio_event_i_6c7d81_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="registration",
        ...
        migrations.AddIndex(
            model_name="registration",
            index=models.Index(
                fields=["event", "attendance_eligible"],
                name="registratio_event_i_43b1fb_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="registration",
            index=models.Index(
                fields=["user", "status"], name="registratio_user_id_d8db7a_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["event", "registration"], name="attendance__event_i_05e0d9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="attendancerecord",
            index=models.Index(
                fields=["event", "is_matched"], name="attendance__event_i_4d1371_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="attendancerecord",
            index=models.Index(
                fields=["zoom_user_email"], name="attendance__zoom_us_dcc972_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="attendancerecord",
            index=models.Index(
                fields=["zoom_participant_id"], name="attendance__zoom_pa_47f605_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="attendancerecord",
            index=models.Index(
                fields=["join_time"], name="attendance__join_ti_173a90_idx"
            ),
        ),
    ]
