...
class SubscriptionAdmin(admin.ModelAdmin):
    ...
    readonly_fields = [
        'uuid', 'stripe_subscription_id', 'stripe_customer_id',
    ...
    fieldsets = (
        ...
        ('Usage', {
            'fields': ('events_created_this_period', 'certificates_issued_this_period')
        }),
        ('Metadata', {
...
class InvoiceAdmin(admin.ModelAdmin):
    ...
    readonly_fields = [
        'uuid', 'stripe_invoice_id', 'amount_display',
        'created_at', 'updated_at'
    ]
...
class PaymentMethodAdmin(admin.ModelAdmin):
    ...
    readonly_fields = [
        'uuid', 'stripe_payment_method_id', 'is_expired',
        'created_at', 'updated_at'
    ]
