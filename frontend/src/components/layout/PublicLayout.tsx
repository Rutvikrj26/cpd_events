          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
            ...
            <div className="col-span-2 lg:col-span-2">
              ...
              <div className="flex items-center gap-3">
                <a href="https://www.linkedin.com/company/accredit-store" target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-lg bg-secondary flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-secondary/80 transition-colors">
