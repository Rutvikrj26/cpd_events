                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-lg text-muted-foreground mb-6">
                            Professional development is essential for career growth, but managing CPD events shouldn't be complicated. We built Accredit to eliminate the administrative burden of tracking attendance and issuing certificates.
                        </p>
